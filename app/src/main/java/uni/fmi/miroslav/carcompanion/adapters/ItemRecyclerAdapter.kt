...
class ItemRecyclerAdapter constructor( private val clickListener: ModelListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    class FixViewHolder constructor(itemView: View, private var onFixClickListener: OnFixClickListener, private val context: Context): RecyclerView.ViewHolder(itemView){
